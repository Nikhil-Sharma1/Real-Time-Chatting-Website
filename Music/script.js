...
const urlsrc = url.get('audio_link');
const names = url.get('audio_name');
const src = `../php/audios/${urlsrc}`;
const ssrc = src;
...
let songs = [
  ...
  { songName: names, filePath: src, coverpath: "1.jpg" }
]
var duration;
